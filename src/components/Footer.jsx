...
function Footer() {
  return (
    <div className='w-full h-screen bg-zinc-900 flex p-20'>
      <div className='w-1/2 h-full flex flex-col justify-between'>
      <div className='heading'>
      <h1 className='font-["Neue_Montreal"] text-[5vw] -mb-1 font-semibold leading-none'>EYE-</h1>
      <h1 className='font-["Neue_Montreal"] text-[5vw] -mb-1 font-semibold leading-none'>OPENING</h1>
      </div>
      ...
      <div className='heading'>
       <h1 className='font-["Neue_Montreal"] text-[5vw] -mb-5 font-semibold leading-none'>PRESENTATIONS</h1>

        <div className='dets font-["Neue_Montreal"] mt-[10vh]'>
           <h1 className='block text-xl font-light '>S:</h1>
        ...
        <div className='dets1 font-["Neue_Montreal"] mt-[10vh]'>
           <h1 className='block text-xl font-light '>L:</h1>
        ...
        <div className='dets1 font-["Neue_Montreal"] mt-[10vh]'>
           <h1 className='block text-xl font-light '>M:</h1>

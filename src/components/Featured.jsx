    ...
    <div className='w-full py-20 bg-zinc-900 '>
      ...
      <div className='px-20'>
        <div className='cards w-full flex gap-10 mt-20'>
          ...
          >
            <h1 className='absolute flex right-0 overflow-hidden translate-x-1/2 top-1/2 -translate-y-1/2 text-[#cdea68] z-[9] text-8xl font-["Neue_Montreal"] leading-none tracking-tighter'>
          ...
          >
            <div className='card w-full h-full rounded-xl overflow-hidden'>
              <h1 className='absolute right-full flex overflow-hidden translate-x-1/2 top-1/2 -translate-y-1/2 text-[#cdea68] z-[9] text-8xl font-["Neue_Montreal"] leading-none tracking-tighter'>
